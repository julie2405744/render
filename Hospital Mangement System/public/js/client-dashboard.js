// ===============================================
//  Hayat Hospital — public/js/client-dashboard.js
// ---------------------------------------------------------
// @Author: Member 3 (Algorithm & Error Handling Engineer)
// @Responsibility: Booking modal logic, frontend math UI, fetch booking
// ---------------------------------------------------------
//  Client features:
//    - Filter doctors by sector
//    - Render doctor cards with booking status
//    - Booking modal with duplicate-doctor guard
//    - My Appointments list with cancel button
// ===============================================
...
function openBookingModal(doctorName) {
    ...
    // Disable form if patient already has this doctor booked
...
function confirmBooking(event) {
    ...
    // Guard: duplicate doctor booking
