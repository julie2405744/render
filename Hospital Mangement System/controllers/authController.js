// Hayat Hospital — controllers/authController.js
// ---------------------------------------------------------
// @Author: Member 1 (Security & Architecture Lead)
// @Responsibility: Password hashing (bcrypt), login/signup logic, session management
// ---------------------------------------------------------
const bcrypt = require('bcryptjs');
const User   = require('../models/User');

// GET /auth — show login/signup page (redirect if already logged in)
...
// POST /auth/signup — create account and log in immediately
