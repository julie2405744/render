// Hayat Hospital — controllers/clientController.js
// ---------------------------------------------------------
// @MainAuthor: Member 3 (Algorithm & Error Handling Engineer)
// @CoAuthors: Member 4 (Uploads), Member 1 (Profile updates)
// ---------------------------------------------------------
...
// @Responsibility: Calculate exact queue positions and clock times based on shift deltas
// Parse a 12-hour time string like "12:28 PM" into { h, m } in 24h.
...
// Calculate the clock time of a patient's appointment based on their position in queue.
// timeSlot format: "May 6, 12:28 PM - 5:25 PM"
...
exports.getDashboard = async (req, res) => {
    try {
        ...
        // Build the current user's enriched bookings (with positionInLine)
...
// POST /client/profile/update-phone — save / update patient phone number
...
// POST /client/profile/upload — upload a medical report file
...
// POST /client/book — create a new booking
// @Author: Member 3 (Algorithm & Error Handling Engineer)
// @Responsibility: Enforce maxCapacity cutoff and prevent duplicate bookings
exports.bookAppointment = async (req, res) => {
    try {
        ...
        // Calculate when the appointment slot finishes (start time + consultation duration)
        const expiresAt = new Date(appointmentTime.getTime() + doctor.avgConsultationTime * 60000);
...
// POST /client/cancel — cancel a booking (locked within 1 hour of appointment)
