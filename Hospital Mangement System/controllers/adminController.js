// Hayat Hospital — controllers/adminController.js
// ---------------------------------------------------------
// @Author: Member 2 (Database & Admin Manager)
// @Responsibility: Full CRUD operations for Doctors, strict backend validation
// ---------------------------------------------------------
...
// Calculate how many patients can be seen given a time slot string and avg consult time.
// timeSlot format: "May 6, 12:28 PM - 5:25 PM"
function calculateCapacity(timeSlot, avgTime) {
    try {
        const parts      = timeSlot.split(' - ');
        // Start time is after the last ", " in parts[0]  e.g. "May 6, 12:28 PM" → "12:28 PM"
...
// POST /admin/doctor — add a new doctor
...
// POST /admin/doctor/edit — update an existing doctor
...
// POST /admin/doctor/delete — delete a doctor
