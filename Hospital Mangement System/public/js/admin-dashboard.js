// ===============================================
//  Hayat Hospital — public/js/admin-dashboard.js
// ---------------------------------------------------------
// @Author: Member 2 (Database & Admin Manager)
// @Responsibility: Admin CRUD fetch requests, frontend form validation for staff
// ---------------------------------------------------------
//  Admin features:
//    - Add a new doctor (name, sector, timeSlot, avgTime)
//    - Click a doctor row to edit their details
//    - Live dashboard table showing queue per doctor
// ===============================================

// ── Helper: Format date + time inputs into a readable slot string ──
...
function openEditForm(doctorName) {
    ...
    // Date/time inputs left blank — admin re-enters them when editing
